...
plot_steps_per_day <- function(steps_per_day, mean_steps, median_steps) {
    ...
    ggplot(steps_per_day, aes(x=steps)) + 
        geom_histogram(fill="grey", binwidth=1500) + 
        geom_point(aes(x=mean_steps, y=0, color="blue"), size=4, shape=15) + 
        geom_point(aes(x=median_steps, y=0, color="red"), size=4, shape=15) + 
